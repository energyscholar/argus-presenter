...
export const coreTools = [
  ...
  },
  {
    ...
    input: { type: 'object', properties: { userId: { type: 'string', description: 'Seat slug, e.g. "vonsydo"' }, granted: { type: 'boolean', default: true, description: 'false revokes' } }, required: ['userId'] },
