 ...
 * already been freed. The worked example is a real live session whose process had exited before
 * anyone came to read its log: that evening's evidence is unrecoverable. Not lost to a bug. Lost
 * because the only copy was in RAM.
 *
