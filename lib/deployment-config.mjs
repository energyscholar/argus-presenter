 ...
 */
export const ROOM_KEYS = Object.freeze(['port', 'bindHosts', 'plugins', 'record', 'voice', 'label', 'profile', 'pluginsDir']);
...
export function roomDefaults() {
  return { port: null, bindHosts: null, plugins: [], record: 'none', voice: false, label: null, profile: null, pluginsDir: null };
}
...
export function normalizeRoomConfig(room, where = '(built-in defaults)', roomName = '(defaultRoom)') {
  ...
  return { ...src, port, bindHosts, plugins, record, voice, label, profile, pluginsDir };
}
...
export const CAPABILITY_KEYS = Object.freeze(['profile', 'voice', 'record', 'pluginsDir']);
