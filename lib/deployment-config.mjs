...
/**
 * Validate + normalize the allowlist: `{ key: {role} }` or the shorthand `{ key: 'role' }`.
...
export const DEPLOYMENT_ROUTED_OPTIONS = Object.freeze([
  'sessionLogDir', 'enforceOAuth', 'allowPasswordCommandOnLAN', ...IDENTITY_KEYS,
]);
